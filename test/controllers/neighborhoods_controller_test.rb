...
class NeighborhoodsControllerTest < ActionController::TestCase
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post :create, neighborhood: { city_id: @neighborhood.city_id, integer: @neighborhood.integer, title: @neighborhood.title }
    end
  ...
  test "should update neighborhood" do
    patch :update, id: @neighborhood, neighborhood: { city_id: @neighborhood.city_id, integer: @neighborhood.integer, title: @neighborhood.title }
    assert_redirected_to neighborhood_path(assigns(:neighborhood))
  end
