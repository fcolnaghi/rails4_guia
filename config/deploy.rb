...
EC2_SERVER_HOSTNAME = 'ec2-54-81-164-2.compute-1.amazonaws.com'
...
set :application,                "guia041"
set :deploy_to,                  "/var/www/apps/guia041"
...
# SCM Options
set :scm,        :git
set :repository, "git@github.com:#{GITHUB_ACCOUNT}/#{GITHUB_REPOSITORY_NAME}.git"
set :branch,     "master"

# Roles
role :app, EC2_SERVER_HOSTNAME
role :db,  EC2_SERVER_HOSTNAME, :primary => true
...
after 'deploy:update_code' do
  ...
  run "cd /usr/local/lib/ruby/gems/2.1.0/gems/sunspot_solr-2.1.0/bin; sunspot-solr stop; sunspot-solr start"
end
